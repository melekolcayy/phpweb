...
<html>
 ...
 <body>
  <div class="container">
   <br />
   <h3 align="center"><a href="#">ÖDEME</a></h3>
   <br />
   <span id="message"></span>
   <div class="panel panel-default">
    <div class="panel-heading">Sipariş Süreci</div>
      ...
      <div class="row">
       <div class="col-md-8" style="border-right:1px solid #ddd;">
        ...
        <div class="form-group">
         <label><b>Kart Sahibinin Adı <span class="text-danger">*</span></b></label>
           ...
           <div class="form-group">
            <label><b>E-mail Adresi <span class="text-danger">*</span></b></label>
           ...
           <div class="form-group">
              ...
              <div class="form-group">
                 <div class="row">
                  <div class="col-md-4">
                   <label>Vade Ayı</label>
                   <input type="text" name="card_expiry_month" id="card_expiry_month" class="form-control" placeholder="AA" maxlength="2" onkeypress="return only_number(event);" />
                   <span id="error_card_expiry_month" class="text-danger"></span>
                  </div>
                  <div class="col-md-4">
                   <label>Vade Yılı</label>
        ...
        <div align="center">
         ...
         <input type="button" name="button_action" id="button_action" class="btn btn-success btn-sm" onclick="stripePay(event)" value="Şimdi Öde" />
        </div>
        <br />
       </div>
       <div class="col-md-4">
...
<script>
var stripe = Stripe('pk_test_51Gv9vWBMOt6RSjdkp7Pximz0S8GGwI1fL4KAIJLIOW7qexMpADzqWv63KO5u6CC54PKAv7KZiTkZEuhRYsjJkYnu00pA0W3Asw');
...
Stripe.setPublishableKey('	pk_test_51Gv9vWBMOt6RSjdkp7Pximz0S8GGwI1fL4KAIJLIOW7qexMpADzqWv63KO5u6CC54PKAv7KZiTkZEuhRYsjJkYnu00pA0W3Asw');
