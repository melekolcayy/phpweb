                        ...
                        <div class="row">
                            <div class="col-xl-4 col-lg-5 col-md-6 col-sm-7 col-9">
                                <div class="slider-caption">
                                    ...
                                    <a href="indexx.php" class="btn btn-primary animation" data-animation="fadeInUp" data-animation-delay="1s">Şimdi Satın Al</a>
                                </div>
                            </div>
                        </div>
                    </div>
					...
					<div class="item">
                    	<div class="product-box common-cart-box">
                            ...
                            <div class="product-info common-cart-info text-center">
                            	<a href="indexx.php" class="cart-name"><?=$urunler["baslik"];?></a>
