...
if(isset($_POST["token"]))
{
 ...
 sk_test_51Gv9vWBMOt6RSjdkQlFuyXNXorunOJQVbA2g7EG49UXKrQoc4wBEI1IiMgKZK6wIm3HH15CTAaHgGlxSZngq7jjb00d8SL38zP');
 ...
 if($response["amount_refunded"] == 0 && empty($response["failure_code"]) && $response['paid'] == 1 && $response["captured"] == 1 && $response['status'] == 'succeeded')
 {
  ...
  $_SESSION["success_message"] = "Ödemeniz başarıyla tamamlandı. The TXN ID is " . $response["balance_transaction"] . "";
