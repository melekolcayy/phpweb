                    	...
                    	<div class="header-logo">
                      	...
                      	<div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                                	<a class="nav-link" href="store.php">Alışveriş</a>
                                </li>
                                <li class="nav-item">
                        	...
                        	<ul>
                            	<li><a href="store.php">Ahşap<span>(10)</span></a></li>
                                <li><a href="store.php">Tablo<span>(05)</span></a></li>
                                <li><a href="store.php">Bere<span>(15)</span></a></li>
                                <li><a href="store.php">Cam ve Porselen<span>(20)</span></a></li>
                                <li><a href="store.php">Aksesuar<span>(07)</span></a></li>
                            </ul>
                        </div>
                                        </nav>
                                    </div>
...
<section class="slider pt-0">
                        ...
                        <div class="row">
                            <div class="col-xl-4 col-lg-5 col-md-6 col-sm-7 col-9">
                                <div class="slider-caption">
                                    <h1 class="animation" data-animation="fadeInDown" data-animation-delay="0.2s">İNDİRİM GÜNÜ</h1>
                                    <p class="animation" data-animation="fadeInUp" data-animation-delay="0.6s"> Yarın alışveriş eşyalarınızda% 50'ye varan indirimlerden yararlanın!</p>
                                    <a href="store.php" class="btn btn-primary animation" data-animation="fadeInUp" data-animation-delay="1s">Şimdi Satın Al</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-xl-4 col-lg-5 col-md-6 col-sm-7 col-9">
                                <div class="slider-caption text-center">
                                    <h1 class="animation" data-animation="fadeInDown" data-animation-delay="0.2s">İNDİRİM GÜNÜ</h1>
                                    <p class="animation" data-animation="fadeInUp" data-animation-delay="0.6s">Yarın alışveriş eşyalarınızda% 50'ye varan indirimlerden yararlanın!</p>
                                    <a href="shop.html" class="btn btn-primary animation" data-animation="fadeInUp" data-animation-delay="1s">Şimdi Satın Al</a>
                                </div>
                            </div>
                        </div>
                    </div>
	...
	<div class="container">
        ...
        $products = $conn->query("SELECT * FROM urunler ", PDO::FETCH_ASSOC)->fetchAll();
  
       ?>
		<div class="row">
			<div class="col-12">
				<div class="products-slider4 same-nav owl-carousel owl-theme" data-margin="30" data-dots="false" data-nav="true">
                <?php foreach($products as $urunler){ ?>

					<div class="item">
                    	<div class="product-box common-cart-box">
                        	<div class="product-img common-cart-img">
                            	<img src=<?=$urunler["resim"];?> alt="<?=$urunler["baslik"];?>">
                               
                            </div>
                            <div class="product-info common-cart-info text-center">
                            	<a href="ürün-detay.html" class="cart-name"><?=$urunler["baslik"];?></a>
...
<script src="yonetim\js\custom.js" type="text/javascript"></script>
</body>
</html>	